...
plt.plot(p_list, cum_matrix[1], '-p', label='Gob.Lin')
plt.plot(p_list, cum_matrix[4], '-s', label='GraphUCB-Local')
plt.plot(p_list, cum_matrix[3], '-o', label='GraphUCB')
plt.plot(p_list, cum_matrix[2], '-*', label='CLUB')
plt.legend(loc=1, fontsize=12)
plt.xlabel('Edge Prob', fontsize=16)
