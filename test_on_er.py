...
p_list=np.round(np.linspace(0,1,20), decimals=2)
...
plt.plot(p_list, cum_matrix[4], '-s',markevery=0.1, label='GraphUCB-Local')
plt.plot(p_list, cum_matrix[3], '-o',markevery=0.1, label='GraphUCB')
plt.plot(p_list, cum_matrix[2], '-*',markevery=0.1, label='CLUB')
