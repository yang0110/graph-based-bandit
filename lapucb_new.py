...
class LAPUCB_NEW(): 
	...
	def run(self,  user_array, item_pool_array, iteration):
		...
		for time in range(iteration):	
			print('time/iteration', time, iteration,'~~~LAPUCB NEW')
		...
		return np.array(cumulative_regret), learning_error_list, self.beta_list, self.a_list, self.b_list, self.c_list,	self.M_ii_list,self.M_inv_ij_list,self.bias_ij_list
