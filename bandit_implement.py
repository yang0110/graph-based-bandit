...
true_adj=RBF_graph(user_num, dimension, thres=thres)
...
gob_model=GOB(dimension, user_num, item_num, pool_size, item_feature_matrix, user_feature_matrix, true_payoffs, true_normed_lap, alpha/10.0, delta, sigma, beta)
...
club_model = CLUB(dimension, user_num, item_num, pool_size, item_feature_matrix, user_feature_matrix, true_payoffs,true_normed_lap, alpha, alpha_2, delta, sigma, beta)
...
colin_regret, colin_error, colin_beta=colin_model.run(alpha, user_seq, item_pool_seq, iteration)
lapucb_regret, lapucb_error, lapucb_beta=lapucb_model.run(alpha/2, user_seq, item_pool_seq, iteration)
...
# plt.axis('off')
# plt.savefig(path+'network_ba'+'.png', dpi=300)
