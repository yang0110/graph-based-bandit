...
plt.tight_layout()
plt.savefig(path+'graphucb_vs_smooth_er_binary'+'.png', dpi=100)
plt.show()


np.save(path+'graphucb_smooth_er_binary.npy', graphucb_regret)
np.save(path+'graphucb_local_smooth_er_binary.npy', local_regret)
