...
plt.legend(loc=1, fontsize=10)
plt.tight_layout()
plt.savefig(path+'graph_error_delicious_user_num_%s_item_num_%s'%(user_num, item_num)+'.png', dpi=300)
plt.savefig(path+'graph_error_delicious_user_num_%s_item_num_%s'%(user_num, item_num)+'.eps', dpi=300)
plt.show()
