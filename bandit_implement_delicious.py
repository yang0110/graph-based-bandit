...
true_payoffs=np.load(input_path+'binary_rating_matrix_100_user_500_bookmark.npy')
...
# plt.axis('off')
# plt.savefig(path+'graph_delicious_user_num_%s_item_num_%s'%(user_num, item_num)+'.png', dpi=300)
# plt.savefig(path+'graph_delicious_user_num_%s_item_num_%s'%(user_num, item_num)+'.eps', dpi=300)
# plt.clf()
