...
plt.tight_layout()
plt.savefig(path+'graphucb_vs_smooth_ws_binary'+'.png', dpi=100)
plt.show()

np.save(path+'smoothness_list_binary.npy', smoothness_list)
np.save(path+'graphucb_smooth_ws_binary.npy', graphucb_regret)
np.save(path+'graphucb_local_smooth_ws_binary.npy', local_regret)
