...
for thres in thres_list:
	...
	plt.tight_layout()
	plt.savefig(path+'cum_regret_rbf_sparsity_%s_edge_num_%s'%(int(thres*10), edge_num)+'.png', dpi=300)
	plt.savefig(path+'cum_regret_rbf_sparsity_%s_edge_num_%s'%(int(thres*10), edge_num)+'.eps', dpi=300)
	...
	plt.tight_layout()
	plt.savefig(path+'bandit_learning_error_rbf_sparsity_%s_edge_num_%s'%(int(thres*10), edge_num)+'.png', dpi=300)
	plt.savefig(path+'bandit_learning_error_rbf_sparsity_%s_edge_num_%s'%(int(thres*10), edge_num)+'.eps', dpi=300)
	...
	plt.legend(loc=1, fontsize=10)
	plt.tight_layout()
	plt.savefig(path+'bandit_beta_rbf_sparsity_%s_edge_num_%s'%(int(thres*10), edge_num)+'.png', dpi=300)
	plt.savefig(path+'bandit_beta_rbf_sparsity_%s_edge_num_%s'%(int(thres*10), edge_num)+'.eps', dpi=300)
