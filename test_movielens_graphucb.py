...
lapucb_regret_matrix_alpha=np.zeros((alpha_length, iteration))
lapucb_error_matrix_alpha=np.zeros((alpha_length, iteration))
lapucb_sim_regret_matrix_alpha=np.zeros((alpha_length, iteration))
lapucb_sim_error_matrix_alpha=np.zeros((alpha_length, iteration))
...
for index, alpha in enumerate(alpha_list):
	...
	lapucb_regret_matrix_alpha[index]=lapucb_regret
	lapucb_error_matrix_alpha[index]=lapucb_error
	lapucb_sim_regret_matrix_alpha[index]=lapucb_sim_regret
	lapucb_sim_error_matrix_alpha[index]=lapucb_sim_error
...
plt.figure(figsize=(5,5))
p=plt.plot(lapucb_regret_matrix_alpha.T)
plt.legend(p, alpha_list)
plt.xlabel('Time')
plt.ylabel('Cumulative Regret')
plt.title('GraphUCB')
...
plt.figure(figsize=(5,5))
p=plt.plot(lapucb_sim_regret_matrix_alpha.T)
plt.legend(p, alpha_list)
plt.xlabel('Time')
plt.ylabel('Cumulative Regret')
plt.title('GraphUCB-Local')
plt.show()
...
plt.plot(lapucb_error, '-*',color='r',  markevery=0.1, label='GraphUCB')
